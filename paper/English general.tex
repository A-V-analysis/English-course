...
\begin{figure}[htbp]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tikzpicture}[node distance=2cm]
            ...
            \node (process4)[process,below of=process3,yshift=0cm,xshift=0cm]{Research Methods: Web crawlers. (NLP analysis, etc)};
            \node (process5)[process,below of=process4,yshift=0cm,xshift=-4.5cm]{Track the Changes of Meme within Different Video Contexts};
            \node (process6)[process,below of=process4,yshift=0cm,xshift=4.5cm]{Assess the Level of Cyberbullying};
            \node (process7)[process,below of=process4,yshift=-2cm,xshift=0cm]{Data Analysis. (Correlation between the degree of Meme and the level of Cyberbullying, etc)};
            \node (end)[startstop,below of=process7,yshift=0cm,xshift=0cm]{Analytical Results: Impact of Abstract Culture on Cyberbullying};
...
%\subsection{Results of Questionnaire Survey}
...
%While the survey focused on the behaviors of online communities, 
